...
public class ItemBaseManaSpark extends ItemBase {
    public ItemBaseManaSpark(ModX mod, Properties properties) {
    ...
    public static boolean attachSpark(Level world, BlockPos pos, ItemStack stack) {
        ...
        if (attach != null && attach.canAttachSpark(stack) && attach.getAttachedSpark() == null) {
            if (!world.isClientSide) {
                stack.shrink(1);
                EntityBaseManaSpark spark = new EntityBaseManaSpark(world);
