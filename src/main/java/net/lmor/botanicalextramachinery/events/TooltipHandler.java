    ...
    public static void onTooltip(ItemTooltipEvent event) {
        ...
        if (!stack.isEmpty()){
            ...
            if (tooltipSparks.contains(stack.getItem().asItem())) {
                ...
                if (transfer != 0) {
                    event.getToolTip().add(new TranslatableComponent("botanicalextramachinery.tooltip.item.sparkTransfer", NumberFormatter.formatInteger(transfer)));
                }
            }
        }
        ...
        if (stack.getItem().asItem() == ModItems.catalystPetal.asItem()){
            event.getToolTip().add(new TranslatableComponent("botanicalextramachinery.tooltip.item.catalyst_petal_1"));
            event.getToolTip().add(new TranslatableComponent("botanicalextramachinery.tooltip.item.catalyst_petal_3"));
        }

        if (stack.getItem().asItem() == ModItems.catalystPetalBlock.asItem()){
            event.getToolTip().add(new TranslatableComponent("botanicalextramachinery.tooltip.item.catalyst_petal_2"));
            event.getToolTip().add(new TranslatableComponent("botanicalextramachinery.tooltip.item.catalyst_petal_3"));
        }
    }
}