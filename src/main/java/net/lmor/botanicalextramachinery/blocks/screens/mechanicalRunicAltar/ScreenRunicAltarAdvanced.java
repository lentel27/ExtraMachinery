...
public class ScreenRunicAltarAdvanced extends ExtraScreenBase<ContainerRunicAltarAdvanced> {
    ...
    public ScreenRunicAltarAdvanced(ContainerRunicAltarAdvanced menu, Inventory inventory, Component title) {
        ...
        this.imageWidth = ContainerRunicAltarAdvanced.WIDTH_GUI;
        this.imageHeight = ContainerRunicAltarAdvanced.HEIGHT_GUI;
    ...
    protected void renderBg(@Nonnull GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        this.drawDefaultGuiBackgroundLayer(guiGraphics, LibResources.ADVANCED_MECHANICAL_RUNIC_ALTAR_GUI, screenAddInventory,
                new int[] {blockEntity.getCurrentMana()}, new int[] {blockEntity.getMaxMana()}, bars, slotInfo);

        ScreenDrawLabelText.drawLabelText(guiGraphics, this.font, "block.botanicalextramachinery.advanced_runic_altar",
        ...
        if (blockEntity.getProgress() > 0) {
            ...
            guiGraphics.blit(LibResources.ADVANCED_MECHANICAL_RUNIC_ALTAR_GUI, this.leftPos + 102, this.topPos + 41, this.imageWidth, 0, Math.round(11.0F * pct), 37);
        }
