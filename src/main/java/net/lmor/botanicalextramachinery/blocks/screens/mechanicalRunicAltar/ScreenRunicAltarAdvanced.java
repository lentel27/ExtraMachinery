...
public class ScreenRunicAltarAdvanced extends ExtraScreenBase<ContainerRunicAltarAdvanced> {
    ...
    protected void renderBg(@Nonnull GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        this.drawDefaultGuiBackgroundLayer(guiGraphics, LibResources.ADVANCED_MECHANICAL_RUNIC_ALTAR_GUI);
        ...
        if (blockEntity.getProgress() > 0) {
            ...
            guiGraphics.blit(LibResources.ADVANCED_MECHANICAL_RUNIC_ALTAR_GUI, this.leftPos + 87, this.topPos + 31, this.imageWidth, 0, Math.round(11.0F * pct), 37);
        }
    }

    private void drawLabelText(GuiGraphics guiGraphics){
        Component titleText = Component.translatable("block.botanicalextramachinery.advanced_runic_altar");
