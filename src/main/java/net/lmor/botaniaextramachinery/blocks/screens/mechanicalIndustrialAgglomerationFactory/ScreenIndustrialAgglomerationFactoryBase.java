...
public class ScreenIndustrialAgglomerationFactoryBase extends ExtraScreenBase<ContainerIndustrialAgglomerationFactoryBase> {
    ...
    private void drawLabelText(PoseStack poseStack){
        Component titleText = Component.translatable("text.botaniaextramachinery.base_industrial_agglomeration_factory_label_text_1");
        ...
        titleText = Component.translatable("text.botaniaextramachinery.base_industrial_agglomeration_factory_label_text_2");
