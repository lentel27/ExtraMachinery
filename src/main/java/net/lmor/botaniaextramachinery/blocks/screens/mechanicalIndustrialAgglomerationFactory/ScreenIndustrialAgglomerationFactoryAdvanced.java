...
public class ScreenIndustrialAgglomerationFactoryAdvanced extends ExtraScreenBase<ContainerIndustrialAgglomerationFactoryAdvanced> {
    ...
    private void drawLabelText(PoseStack poseStack){
        Component titleText = Component.translatable("text.botaniaextramachinery.advanced_industrial_agglomeration_factory_label_text_1");
        ...
        titleText = Component.translatable("text.botaniaextramachinery.advanced_industrial_agglomeration_factory_label_text_2");
